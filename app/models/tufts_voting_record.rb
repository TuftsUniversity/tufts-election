class TuftsVotingRecord < ActiveFedora::Base
  ...
  def to_solr(solr_doc=Hash.new,opt={})
    ...
    affiliate_ids.delete_if  do |party_id|
      authoratative_party = Party.find(party_id)
      true if authoratative_party.nil? 
    end

    solr_doc["party_affiliation_id_ssim"] =  affiliate_ids - ['null']
