...
describe CandidateHelper do
  ...
  describe "#list_elections" do
    subject {
      Blacklight.solr.should_receive(:get).with('select', :params=>{:q=>'(candidate_id_s:AA00005 OR elector_id_facet:AA00005) AND format:"Election Record"', :fl=>'title_display id'})
