...
describe CandidateHelper do
  ...
  describe "#list_elections" do
    subject {
      Blacklight.solr.should_receive(:get).with('select', :params=>{:q=>'(candidate_id_ssim:AA00005 OR elector_id_ssim:AA00005) AND format_ssim:"Election Record"', :fl=>'title_tesi id', :per_page=>"1000"})
